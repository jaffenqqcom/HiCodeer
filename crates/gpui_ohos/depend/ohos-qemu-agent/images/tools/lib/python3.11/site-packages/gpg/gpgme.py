...
HAVE_FUNC_ATTRIBUTE_VISIBILITY = _gpgme.HAVE_FUNC_ATTRIBUTE_VISIBILITY
...
HAVE_NANOSLEEP = _gpgme.HAVE_NANOSLEEP

HAVE_POLL_H = _gpgme.HAVE_POLL_H
...
GPG_ERR_ENABLE_GETTEXT_MACROS = _gpgme.GPG_ERR_ENABLE_GETTEXT_MACROS
...
GPGME_SIG_MODE_ARCHIVE = _gpgme.GPGME_SIG_MODE_ARCHIVE
...
GPGME_KEYLIST_MODE_FORCE_EXTERN = _gpgme.GPGME_KEYLIST_MODE_FORCE_EXTERN

GPGME_KEYLIST_MODE_LOCATE = _gpgme.GPGME_KEYLIST_MODE_LOCATE

GPGME_KEYLIST_MODE_LOCATE_EXTERNAL = _gpgme.GPGME_KEYLIST_MODE_LOCATE_EXTERNAL
...
GPGME_EXPORT_MODE_SECRET_SUBKEY = _gpgme.GPGME_EXPORT_MODE_SECRET_SUBKEY
...
class _gpgme_subkey(object):
    ...
    can_renc = property(_gpgme._gpgme_subkey_can_renc_get, _gpgme._gpgme_subkey_can_renc_set, doc=r"""can_renc""")
    can_timestamp = property(_gpgme._gpgme_subkey_can_timestamp_get, _gpgme._gpgme_subkey_can_timestamp_set, doc=r"""can_timestamp""")
    is_group_owned = property(_gpgme._gpgme_subkey_is_group_owned_get, _gpgme._gpgme_subkey_is_group_owned_set, doc=r"""is_group_owned""")
...
def gpgme_op_encrypt_result(ctx):
...
GPGME_ENCRYPT_ARCHIVE = _gpgme.GPGME_ENCRYPT_ARCHIVE


def gpgme_op_encrypt_start(ctx, recp, flags, plain, cipher):
...
def gpgme_op_encrypt_ext(ctx, recp, recpstring, flags, plain, cipher):
...
def gpgme_op_encrypt_sign_start(ctx, recp, flags, plain, cipher):
...
def gpgme_op_encrypt_sign(ctx, recp, flags, plain, cipher):
...
def gpgme_op_encrypt_sign_ext_start(ctx, recp, recpstring, flags, plain, cipher):
...
def gpgme_op_encrypt_sign_ext(ctx, recp, recpstring, flags, plain, cipher):
...
def gpgme_op_decrypt_result(ctx):
...
def gpgme_op_decrypt_ext(ctx, flags, cipher, plain):
...
def gpgme_op_sign_result(ctx):
    r"""gpgme_op_sign_result(ctx) -> _gpgme_op_sign_result"""
    return _gpgme.gpgme_op_sign_result(ctx)

def gpgme_op_sign_start(ctx, plain, sig, flags):
    r"""gpgme_op_sign_start(ctx, plain, sig, flags) -> gpgme_error_t"""
    return _gpgme.gpgme_op_sign_start(ctx, plain, sig, flags)

def gpgme_op_sign(ctx, plain, sig, flags):
    r"""gpgme_op_sign(ctx, plain, sig, flags) -> gpgme_error_t"""
    return _gpgme.gpgme_op_sign(ctx, plain, sig, flags)
...
def gpgme_op_verify_result(ctx):
    r"""gpgme_op_verify_result(ctx) -> _gpgme_op_verify_result"""
    return _gpgme.gpgme_op_verify_result(ctx)
GPGME_VERIFY_ARCHIVE = _gpgme.GPGME_VERIFY_ARCHIVE


def gpgme_op_verify_start(ctx, sig, signed_text, plaintext):
...
def gpgme_op_verify(ctx, sig, signed_text, plaintext):
    r"""gpgme_op_verify(ctx, sig, signed_text, plaintext) -> gpgme_error_t"""
    return _gpgme.gpgme_op_verify(ctx, sig, signed_text, plaintext)

def gpgme_op_verify_ext_start(ctx, flags, sig, signed_text, plaintext):
    r"""gpgme_op_verify_ext_start(ctx, flags, sig, signed_text, plaintext) -> gpgme_error_t"""
    return _gpgme.gpgme_op_verify_ext_start(ctx, flags, sig, signed_text, plaintext)

def gpgme_op_verify_ext(ctx, flags, sig, signed_text, plaintext):
    r"""gpgme_op_verify_ext(ctx, flags, sig, signed_text, plaintext) -> gpgme_error_t"""
    return _gpgme.gpgme_op_verify_ext(ctx, flags, sig, signed_text, plaintext)
...
def gpgme_op_import_result(ctx):
    r"""gpgme_op_import_result(ctx) -> _gpgme_op_import_result"""
    return _gpgme.gpgme_op_import_result(ctx)

def gpgme_op_import_start(ctx, keydata):
    r"""gpgme_op_import_start(ctx, keydata) -> gpgme_error_t"""
    return _gpgme.gpgme_op_import_start(ctx, keydata)

def gpgme_op_import(ctx, keydata):
    r"""gpgme_op_import(ctx, keydata) -> gpgme_error_t"""
    return _gpgme.gpgme_op_import(ctx, keydata)

def gpgme_op_import_keys_start(ctx, keys):
    r"""gpgme_op_import_keys_start(ctx, keys) -> gpgme_error_t"""
    return _gpgme.gpgme_op_import_keys_start(ctx, keys)

def gpgme_op_import_keys(ctx, keys):
    r"""gpgme_op_import_keys(ctx, keys) -> gpgme_error_t"""
    return _gpgme.gpgme_op_import_keys(ctx, keys)

def gpgme_op_receive_keys_start(ctx, keyids):
    r"""gpgme_op_receive_keys_start(ctx, keyids) -> gpgme_error_t"""
    return _gpgme.gpgme_op_receive_keys_start(ctx, keyids)

def gpgme_op_receive_keys(ctx, keyids):
    r"""gpgme_op_receive_keys(ctx, keyids) -> gpgme_error_t"""
    return _gpgme.gpgme_op_receive_keys(ctx, keyids)

def gpgme_op_export_start(ctx, pattern, mode, keydata):
...
def gpgme_op_export_keys(ctx, keys, mode, keydata):
...
def gpgme_op_createkey(ctx, userid, algo, reserved, expires, certkey, flags):
...
def gpgme_op_createsubkey_start(ctx, key, algo, reserved, expires, flags):
...
def gpgme_op_createsubkey(ctx, key, algo, reserved, expires, flags):
...
def gpgme_op_set_uid_flag(ctx, key, userid, name, value):
...
def gpgme_op_setexpire_start(ctx, key, expires, subfprs, reserved):
...
def gpgme_op_setexpire(ctx, key, expires, subfprs, reserved):
...
def gpgme_op_keysign_start(ctx, key, userid, expires, flags):
...
def gpgme_op_keysign(ctx, key, userid, expires, flags):
...
def gpgme_op_revsig_start(ctx, key, signing_key, userid, flags):
...
def gpgme_op_revsig(ctx, key, signing_key, userid, flags):
...
def gpgme_op_keylist_from_data_start(ctx, data, reserved):
...
def gpgme_op_trustlist_start(ctx, pattern, max_level):
...
def gpgme_op_spawn_start(ctx, file, argv, datain, dataout, dataerr, flags):
...
def gpgme_op_spawn(ctx, file, argv, datain, dataout, dataerr, flags):
...
def gpgme_op_assuan_transact_start(ctx, command, data_cb, inq_cb, stat_cb):
...
def gpgme_op_assuan_transact_ext(ctx, command, data_cb, inq_cb, stat_cb, op_err):
...
def gpgme_op_vfs_create(ctx, recp, container_file, flags, op_err):
...
def gpgme_op_query_swdb(ctx, name, iversion, reserved):
...
def gpgme_op_card_edit(ctx, key, fnc, fnc_value, out):
...
def gpgme_key_get_string_attr(key, what, reserved, idx):
...
def gpgme_key_get_ulong_attr(key, what, reserved, idx):
...
def gpgme_key_sig_get_string_attr(key, uid_idx, what, reserved, idx):
...
def gpgme_key_sig_get_ulong_attr(key, uid_idx, what, reserved, idx):
...
def gpgme_trust_item_release(item):
    r"""gpgme_trust_item_release(item)"""
    return _gpgme.gpgme_trust_item_release(item)

def gpgme_trust_item_get_string_attr(item, what, reserved, idx):
...
def gpgme_trust_item_get_int_attr(item, what, reserved, idx):
...
def gpgme_op_assuan_result(ctx):
    r"""gpgme_op_assuan_result(ctx) -> _gpgme_op_assuan_result"""
    return _gpgme.gpgme_op_assuan_result(ctx)

def gpgme_op_assuan_transact(ctx, command, data_cb, inq_cb, status_cb, status_cb_value):
...
GPG_ERR_SOURCE_TKD = _gpgme.GPG_ERR_SOURCE_TKD
...
GPG_ERR_BAD_PUK = _gpgme.GPG_ERR_BAD_PUK

GPG_ERR_NO_RESET_CODE = _gpgme.GPG_ERR_NO_RESET_CODE

GPG_ERR_BAD_RESET_CODE = _gpgme.GPG_ERR_BAD_RESET_CODE
