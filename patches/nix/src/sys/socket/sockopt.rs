...
// OHOS: The u8 type instantiation point for sockopt is excluded by cfg, making this struct dead code; allowed here.
...
// OHOS: Same as above; the u8 type instantiation point for sockopt is excluded by cfg.
#[cfg_attr(target_env = "ohos", allow(dead_code))]
struct SetU8 {
    val: u8,
}
...
// OHOS: The utun interface has no instantiation point on OHOS, making this struct dead code.
#[cfg_attr(target_env = "ohos", allow(dead_code))]
